  ...
  return (
    <section className="search-result">
      ...
      <div className="result__header">
        <p className="result__name">{data.name ? data.name : data.login}</p>
      ...
      <section className="result__info">
        <div className={`info__row ${!data.location ? "info--na" : ""}`}>
          <svg
            ...
            role="img"
            aria-labelledby="titleLocation"
          >
            <title id="titleLocation">Location</title>
            <path
        ...
        <div className={`info__row ${!data.blog ? "info--na" : ""}`}>
          <svg
            ...
            className="info__icon"
            role="img"
            aria-labelledby="titleBlog"
          >
            <title id="titleBlog">Blog URL</title>
            <g fill="currentColor">
        ...
        <div
          className={`info__row ${!data.twitter_username ? "info--na" : ""}`}
        >
          <svg
            height="18"
            width="20"
            ...
            className="info__icon"
            role="img"
            aria-labelledby="titleTwitter"
          >
            <title id="titleTwitter">Twitter username</title>
            <path
        ...
        <div className={`info__row ${!data.company ? "info--na" : ""}`}>
          <svg
            ...
            className="info__icon"
            role="img"
            aria-labelledby="titleCompany"
          >
            <title id="titleCompany">Company</title>
            <g fill="currentColor">
